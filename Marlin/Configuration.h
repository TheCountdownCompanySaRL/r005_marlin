...
#define STRING_CONFIG_H_AUTHOR "The CountDown Compagny" // Who made the changes.
#define CUSTOM_VERSION_FILE Version.h // Path from the root directory (no quotes)
#define NO_SERIAL_BOOT
#define NO_ENDSTOPS
...
// Choose the name from boards.h that matches your setup
  ...
  //#define MOTHERBOARD BOARD_RAMPS_DUO_EFF
#endif
 ...
 * :[-2, -1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
//#define SERIAL_PORT_2 1 // Z+,Z- on ramps
...
#define CUSTOM_MACHINE_NAME " TCDC Carbon Printer"
...
#define USE_ZMIN_PLUG  //-> Used for serial 1
...
#define PREHEAT_3_LABEL       "PEKK"
#define PREHEAT_3_TEMP_HOTEND 400
